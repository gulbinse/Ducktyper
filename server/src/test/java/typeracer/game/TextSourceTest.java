...
class TextSourceTest {
    ...
    @Test
    void testTextFromWrongURL() {
        assertThrows(FileNotFoundException.class, () -> textSource.setTextFromFile(new File("server/src/main/resources/text_sources/dasIstKeineValideURL.txt"))
        );
    }
}
