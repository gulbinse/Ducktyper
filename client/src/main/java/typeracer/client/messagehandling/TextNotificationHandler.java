...
public class TextNotificationHandler implements MessageHandler {
  ...
  /**
   * Constructs a TextNotificationHandler. Initializes the handler with the specified next handler
   * and view controller.
   *
   ...
   */
  TextNotificationHandler(MessageHandler nextHandler, ViewController viewController) {
