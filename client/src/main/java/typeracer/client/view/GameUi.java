...
public class GameUi extends VBox {
    ...
    private void initUi() {
        ...
        setBackground(new Background(new BackgroundFill(StyleManager.START_SCREEN, CornerRadii.EMPTY, Insets.EMPTY)));
        addUserLabel();
        addDisplayPanel();
        addInputPanel();
        addPlayersPanel();
  ...
  public void onViewShown() {
    ...
    private void addUserLabel() {
        ...
        usernameLabel.setBackground(new Background(new BackgroundFill(Color.LIGHTGRAY, new CornerRadii(5), Insets.EMPTY)));
     ...
     *
     * <p>Sets the uncopied game text to the game text obtained from the view controller.
     */
     ...
     *
     * <p>If the typed character is correct, it moves the character from the uncopied text to the
     * copied text.
    ...
    public void addPlayer(int playerId) {
        ...
        ImageView racer = new ImageView(new Image(getClass().getResourceAsStream("/images/gooseanimation.gif")));
    ...
    private void addButtonPanel() {
        ...
        Button exitButton = StyleManager.createStyledButton("exit", StyleManager.RED_BUTTON, StyleManager.STANDARD_FONT);
    ...
    private void attemptToExitGame() {
        Alert alert = new Alert(AlertType.CONFIRMATION, "Are you sure you want to leave the game?", ButtonType.YES, ButtonType.NO);
